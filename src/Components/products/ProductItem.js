...
const Products = ({ cartItems, setCartItems}) => {
  ...
  return (
    <>
    <NavigationBar cartItems={cartItems} showSlideshow={true} showHeader = {true} showDropdown={true} onSearch={setSearchTerm} />



    <div className="container">
      
      <h1 style={{position:'relative',top:'-90px',marginBottom:'1rem'}} id="heading">Furnitures</h1>        
