...
import Product from '../DummyData/Product2';
...
function ProductItem2({ cartItems, setCartItems }) {
  ...
  const [products1, setProducts1] = useState(Product.laptops);
  ...
  return (
    <>
      ...
      <div className="container">
        <br></br>
        <h1 style={{ position: 'relative', top: '0px', marginBottom: '1rem' }} id="heading">Electornics</h1>
        <br></br>
        <h2>Mobiles</h2>
        <br></br>
        <br></br>
